...
namespace Asawer
{
    ...
    public static class Settings
    {
        ...
        public static bool FirstVisit
        {
            get
            {
                return AppSettings.GetValueOrDefault(Constants.Settings.FirstVisitPreferenceName, true);
            }
            set
            {
                AppSettings.AddOrUpdateValue(Constants.Settings.FirstVisitPreferenceName, value);
            }
        }

package md57a6f08dbc6561d468b2675b2ac9edab2;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.InAppBilling.InAppBillingImplementation+InAppBillingServiceConnection, Plugin.InAppBilling, Version=1.2.4.0, Culture=neutral, PublicKeyToken=null", InAppBillingImplementation_InAppBillingServiceConnection.class, __md_methods);
	}
	...
	public InAppBillingImplementation_InAppBillingServiceConnection ()
	{
		...
		if (getClass () == InAppBillingImplementation_InAppBillingServiceConnection.class)
			mono.android.TypeManager.Activate ("Plugin.InAppBilling.InAppBillingImplementation+InAppBillingServiceConnection, Plugin.InAppBilling, Version=1.2.4.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
	...
	public InAppBillingImplementation_InAppBillingServiceConnection (android.content.Context p0)
	{
		super ();
		if (getClass () == InAppBillingImplementation_InAppBillingServiceConnection.class)
			mono.android.TypeManager.Activate ("Plugin.InAppBilling.InAppBillingImplementation+InAppBillingServiceConnection, Plugin.InAppBilling, Version=1.2.4.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}

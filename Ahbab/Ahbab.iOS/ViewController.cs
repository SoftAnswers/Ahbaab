...
namespace Asawer.iOS {
    public partial class ViewController : UIViewController {
        ...
        static void GetData() {
            Ahbab.statusItems = AhbabDatabase.GetSpinnerItems(Constants.Database.ApiFiles.GetSpinnerItemsFileName, Constants.Database.Tables.Status);
            Ahbab.statusItems.Insert(0, new SpinnerItem(-1, "Choose", Constants.DefaultValues.FamilyStatus));
            Ahbab.mAgeItems = AhbabDatabase.GetSpinnerItems(Constants.Database.ApiFiles.GetTwoColumnsSpinnersItemFileName, Constants.Database.Tables.Age);
            Ahbab.mAgeItems.Insert(0, new SpinnerItem(0, "Choose", Constants.DefaultValues.Age));
            Ahbab.mContactTimeItems = AhbabDatabase.GetSpinnerItems(Constants.Database.ApiFiles.GetTwoColumnsSpinnersItemFileName, Constants.Database.Tables.ContactTime);
            Ahbab.mContactTimeItems.Insert(0, new SpinnerItem(0, "Choose", Constants.DefaultValues.ContactTime));
            Ahbab.mEducationItems = AhbabDatabase.GetSpinnerItems(Constants.Database.ApiFiles.GetSpinnerItemsFileName, Constants.Database.Tables.Education);
            Ahbab.mEducationItems.Insert(0, new SpinnerItem(0, "Choose", Constants.DefaultValues.EducationLevel));
            Ahbab.mEyesColorItems = AhbabDatabase.GetSpinnerItems(Constants.Database.ApiFiles.GetSpinnerItemsFileName, Constants.Database.Tables.EyesColor);
            Ahbab.mEyesColorItems.Insert(0, new SpinnerItem(0, "Choose", Constants.DefaultValues.EyesColor));
            Ahbab.mGoalFromSiteItems = AhbabDatabase.GetSpinnerItems(Constants.Database.ApiFiles.GetSpinnerItemsFileName, Constants.Database.Tables.GoalFromSite);
            Ahbab.mGoalFromSiteItems.Insert(0, new SpinnerItem(0, "Choose", Constants.DefaultValues.GoalFromSite));
            Ahbab.mHairColorItems = AhbabDatabase.GetSpinnerItems(Constants.Database.ApiFiles.GetSpinnerItemsFileName, Constants.Database.Tables.HairColor);
            Ahbab.mHairColorItems.Insert(0, new SpinnerItem(0, "Choose", Constants.DefaultValues.HairColor));
            Ahbab.mHeightItems = AhbabDatabase.GetSpinnerItems(Constants.Database.ApiFiles.GetSpinnerItemsFileName, Constants.Database.Tables.Height);
            Ahbab.mHeightItems.Insert(0, new SpinnerItem(0, "Choose", Constants.DefaultValues.Height));
            Ahbab.mJobItems = AhbabDatabase.GetSpinnerItems(Constants.Database.ApiFiles.GetSpinnerItemsFileName,Constants.Database.Tables.Job);
            Ahbab.mJobItems.Insert(0, new SpinnerItem(0, "Choose", Constants.DefaultValues.Job));
            Ahbab.mCountries = AhbabDatabase.GetSpinnerItems(Constants.Database.ApiFiles.GetSpinnerItemsFileName, Constants.Database.Tables.Countries);
            Ahbab.mCountries.Insert(0, new SpinnerItem(0, "Choose", Constants.DefaultValues.OriginCountry));
            Ahbab.mResidenceCountries = AhbabDatabase.GetSpinnerItems(Constants.Database.ApiFiles.GetSpinnerItemsFileName, Constants.Database.Tables.Countries);
            Ahbab.mResidenceCountries.Insert(0, new SpinnerItem(0, "Choose", Constants.DefaultValues.ResidenceCountry));
            Ahbab.mContactWays = AhbabDatabase.GetSpinnerItems(Constants.Database.ApiFiles.GetSpinnerItemsFileName, Constants.Database.Tables.ContactWays);
            Ahbab.mTimeItems = AhbabDatabase.GetSpinnerItems(Constants.Database.ApiFiles.GetTwoColumnsSpinnersItemFileName, Constants.Database.Tables.Time);
            Ahbab.mTimeItems.Insert(0, new SpinnerItem(0, "Choose", Constants.DefaultValues.TimeZone));
            Ahbab.mWeightItems = AhbabDatabase.GetSpinnerItems(Constants.Database.ApiFiles.GetSpinnerItemsFileName, Constants.Database.Tables.Weight);
